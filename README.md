...
``` ruby
platform :ios, '6.1'
pod 'THCalendarDatePicker', '~> 0.2.1'
```
...
- Fixed issue [#7](https://github.com/hons82/THCalendarDatePicker/issues/7) and [#5](https://github.com/hons82/THCalendarDatePicker/issues/5) 
